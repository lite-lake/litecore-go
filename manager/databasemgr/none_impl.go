...
func NewDatabaseManagerNoneImpl() DatabaseManager {
	...
	baseImpl := newDatabaseManagerBaseImpl("none", "none", db)
	// 不初始化可观测性（none 驱动不需要）
...
// ManagerName 返回管理器名称
func (n *noneImpl) ManagerName() string {
	return n.name
}

// Health 返回错误（覆盖基类方法）
func (n *noneImpl) Health() error {
	return errors.New("database not available (none driver)")
}

// OnStart 启动时初始化
func (n *noneImpl) OnStart() error {
	// none 驱动不需要初始化
	return nil
}

// OnStop 停止时清理
func (n *noneImpl) OnStop() error {
	// none 驱动不需要清理
	return nil
}
...
// DB 返回 nil（覆盖基类方法）
func (n *noneImpl) DB() *gorm.DB {
	return nil
}

// Model 返回空 DB
func (n *noneImpl) Model(value any) *gorm.DB {
	return nil
}

// Table 返回空 DB
func (n *noneImpl) Table(name string) *gorm.DB {
	return nil
}

// WithContext 返回空 DB
func (n *noneImpl) WithContext(ctx context.Context) *gorm.DB {
	return nil
}
...
// Transaction 返回错误
func (n *noneImpl) Transaction(fn func(*gorm.DB) error, opts ...*sql.TxOptions) error {
	return fmt.Errorf("database not available (none driver)")
}

// Begin 返回空 DB
func (n *noneImpl) Begin(opts ...*sql.TxOptions) *gorm.DB {
	return nil
}
...
// AutoMigrate 返回错误
func (n *noneImpl) AutoMigrate(models ...any) error {
	return fmt.Errorf("database not available (none driver)")
}

// Migrator 返回 nil
func (n *noneImpl) Migrator() gorm.Migrator {
	return nil
}
...
// Driver 获取驱动类型
func (n *noneImpl) Driver() string {
	return n.driver
}

// Ping 返回错误（覆盖基类方法）
func (n *noneImpl) Ping(ctx context.Context) error {
	return fmt.Errorf("database not available (none driver)")
}

// Stats 返回空统计
func (n *noneImpl) Stats() sql.DBStats {
	return sql.DBStats{}
}
...
// Exec 返回空 DB
func (n *noneImpl) Exec(sql string, values ...any) *gorm.DB {
	return nil
}

// Raw 返回空 DB
func (n *noneImpl) Raw(sql string, values ...any) *gorm.DB {
	return nil
}
